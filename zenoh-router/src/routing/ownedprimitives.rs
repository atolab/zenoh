...
impl OwnedPrimitives {
    ...
    pub async fn resource(self, rid: ZInt, reskey: ResKey) {self.primitives.resource(rid, &reskey).await}
    pub async fn forget_resource(self, rid: ZInt) {self.primitives.forget_resource(rid).await}
    
    pub async fn publisher(self, reskey: ResKey) {self.primitives.publisher(&reskey).await}
    pub async fn forget_publisher(self, reskey: ResKey) {self.primitives.forget_publisher(&reskey).await}
    ...
    pub async fn reply(self, qid: ZInt, reply: Reply) {self.primitives.reply(qid, &reply).await}
    ...
    pub async fn close(self) {self.primitives.close().await}
}